	...
	<div id="element" class="hero-body">
	  <div class="thumbnail_gallery">
				...
				<div id="myGallery" class="spacegallery">
					<img src="images/spa5.jpg" alt="" />
					<img src="images/spa6.jpg" alt="" />
					<img src="images/spa7.jpg" alt="" />
					<img src="images/spa8.jpg" alt="" />
					<img src="images/spa11.jpg" alt="" />
					<img src="images/spa12.jpg" alt="" />
					<img src="images/spa13.jpg" alt="" />
					<img src="images/spa15.jpg" alt="" />
				</div>
            </div>
			</div>
			  <div class="thumbnail_mission">
			  <h2>Mission</h2>
			  <p>Sudur Pashchimanchal Academy (SPA) Voting System serving as a training ground for education students,seeks to develop in excellence
...
Vision Train and develop highly motivated and committed professional elementary and secondary teachers equipped with instructional,personal and social competencies conducive to teh task of human development.
	  ...
	  <div class="modal-footer">
	    <a href="#" class="btn" data-dismiss="modal">Close</a>
			  ...
			  <p>
				To digitize the student election process by making it more efficient, secure, and accessible by replacing manual paper-based voting with a web-based system. 
				To ensure fair and transparent elections by enforcing one-person-one-vote, maintaining vote confidentiality, and preventing vote tampering.
			  </p>
