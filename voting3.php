...
<body>
	...
	<div class="container">
		...
		<a class="brand">
		<img src="admin/images/sp1.png" width="60" height="60">
 	</a>
	<a class="brand">
	 <h2>Sudur Pashchimanchal Academy (SPA) Voting System</h2>
	 <div class="chmsc_nav"><font size="4" color="white">Dhangadhi City College</font></div>
 	</a>
...
<?php 
$representative=mysqli_query($conn,"select * from candidate where Position='3rd Year Representative'")or die(mysqli_error());
